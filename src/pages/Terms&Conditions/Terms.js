...
const Terms = () => {
  return (
    <div className="privacy">
      <Container>
        <h1 className="main-text">Terms & Conditions</h1>
        ...
        <Row>
          <Col>
            <p>
              ...
              property rights related to it, still belong to Udit Dugar.
            </p>
            <p>
              Udit Dugar is committed to ensuring that the app is as useful and
            ...
            <p>
              The Memofac app stores and processes personal data that you have
              ...
              the Memofac app won’t work properly or at all.
            </p>
            <p>
            ...
            <p>
              Google Play Services <br /> Google Analytics for Firebase <br />{' '}
              You should be aware that there are certain things that Udit Dugar
              ...
              provider, but Udit Dugar cannot take responsibility for the app
            ...
            <p>
              Along the same lines, Udit Dugar cannot always take responsibility
              ...
              turn it on to avail the Service, Udit Dugar cannot accept
              responsibility.
            </p>
            <p>
              With respect to Udit Dugar’s responsibility for your use of the
              ...
              to us so that we can make it available to you. Udit Dugar accepts
            ...
            <p>
              ...
              want to keep using the app. Udit Dugar does not promise that it
